...
if($total_reg > 0){
echo <<<HTML
	<table class="table table-hover" id="tabela" style="font-size: 13px">
		<thead> 
			<tr> 				
				<th>Descrição</th>
...
$query2 = $pdo->query("SELECT * FROM usuarios where id = '$vendedor'");
$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
if(@count($res2) > 0){
...
echo <<<HTML
		...
		<a title="Cancelar Venda" href="#" class="dropdown-toggle {$ocultar_cancelar}" data-toggle="dropdown" aria-expanded="false"><big><i class="fa fa-ban text-danger"></i></big></a>

		<ul class="dropdown-menu" style="margin-left:-230px;">
		<li>
		<div class="notification_desc2">
		<p>Confirmar Cancelamento? <a href="#" onclick="excluir('{$id}', '{$descricao}')"><span class="text-danger">Sim</span></a></p>
		</div>
		</li>										
		</ul>
		</li>
					...
					<big><a href="rel/comprovante.php?id={$id}&imprimir=Não" target="_blank" title="Ver Comprovante"><i class="fa fa-file-pdf-o " style="color:green"></i></a></big>
				</td>  
			</tr> 
HTML;
}
