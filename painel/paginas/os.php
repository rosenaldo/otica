			...
			<form method="post" id="form_orcamento">
					...
					<div class="row">
						<div class="col-md-5">		
							...
							<div class="form-group"> 
								...
								<input maxlength="1000" class="form-control" type="text" name="situacao" id="situacao"  placeholder="Troca de Armação, Troca de Lente, etc">
							</div>	
						</div>
				...
				<div class="row">
						<div class="col-md-2">		
							<div class="form-group"> 
								<label>Lente</label> 
								<input class="form-control" type="text" name="lente" id="lente"  placeholder="Lente">
							</div>	
						</div>
							...
							<div class="form-group"> 
								<label>C. Ótico</label> 
								<input maxlength="1000" class="form-control" type="text" name="cotico" id="cotico"  placeholder="C. Ótico">
							</div>	
						</div>
						...
						<div class="col-md-2">		
							<div class="form-group"> 
								<label>Altura</label> 
								<input class="form-control" type="text" name="altura" id="altura"  placeholder="Altura">
							</div>	
						</div>
						...
						<div class="col-md-2">		
							<div class="form-group"> 
								...
								<input class="form-control" type="retificacao" name="retificacao" id="retificacao"  placeholder="Retificacao">
							</div>	
						</div>
					</div>
				<!--  -->
