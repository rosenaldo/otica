	...
	<div class="col-md-12">
		...
		<div style="float:left; margin-right:150px">
			<button onclick="inserir()" type="button" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i>Nova OS</button>
				...
				<a style="width: 120px" href="#" class="btn btn-danger" onclick="buscar_status('Aberta')">Abertas</a>
					...
					<div class="row">
						<div class="col-md-5">		
							...
							<div class="form-group"> 
								...
								<input maxlength="1000" class="form-control" type="text" name="situacao" id="situacao"  placeholder="Troca de Armação, Troca de Lente, etc" required>
							</div>	
						</div>
