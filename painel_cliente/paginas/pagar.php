...
<div class="row margem_mobile">
	<div class="col-md-9">	
			...
			<select style="width:200px; display: inline-block;" class="form-control" aria-label="Default select example" name="status" id="status" onchange="busca()">
	...
	<div align="right" class="col-md-3">
		<small><i class="fa fa-usd text-danger"></i> <span class="text-dark">Total Vencidas: <span class="text-danger" id="total_itens"></span></span></small>
	</div>
</div>
