			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-mobile"></span> SISTEMA<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<li class="treeview">
								<a href="orcamentos">
									<i class="fa fa-pencil"></i> <span>Meus Orçamentos</span>
								</a>
							</li>
							...
							<li class="treeview">
								<a href="os">
									<i class="fa fa-sun-o"></i> <span>Receitas / Serviços</span>
								</a>
							</li>
